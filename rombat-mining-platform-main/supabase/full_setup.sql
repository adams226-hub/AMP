...
DO $$ BEGIN CREATE TYPE fuel_type AS ENUM (,'essence','gasoil','hybrid','electric');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
DO $$ BEGIN CREATE TYPE oil_transaction_type AS ENUM ('entry','exit');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
-- ============================================================
-- JOURNAUX D'OPÉRATION ÉQUIPEMENT
-- ============================================================
...
CREATE TABLE IF NOT EXISTS fuel_transactions (
  ...
  site             VARCHAR(255),
  equipment_id     UUID      NOT NULL REFERENCES equipment(id),
  fuel_type        fuel_type NOT NULL DEFAULT ,
