...
const ROLE_PERMISSIONS = {
  admin:        ['/', '/executive-dashboard', '/production-management', '/equipment-management', '/fuel-management', '/oil-management', '/accounting', '/administration', '/stock-management', '/data-explorer'],
  directeur:    ['/', '/executive-dashboard', '/production-management', '/equipment-management', '/fuel-management', '/oil-management', '/accounting', '/stock-management', '/data-explorer'],
  chef_de_site: ['/', '/equipment-management', '/oil-management', '/data-explorer'],
  comptable:    ['/', '/accounting', '/data-explorer'],
  equipement:   ['/', '/equipment-management', '/oil-management', '/accounting', '/data-explorer'],
