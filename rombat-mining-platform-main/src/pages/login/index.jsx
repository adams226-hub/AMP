    ...
    <div className="min-h-screen flex items-center justify-center" style={{ background: "linear-gradient(135deg, #FF6B35 0%, #F7931E 100%)" }}>
      <div className="w-full max-w-md p-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">Amp Mines et Carrières</h1>
          <p className="text-white/80">Exploration & Carrières</p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="exemple@ampmines.com"
                  required
                  autoComplete="email"
                />
              </div>
        ...
        <div className="text-center mt-6">
          <p className="text-white/80 text-sm">© 2026 Amp Mines et Carrières</p>
        </div>
      </div>
    </div>
  );
